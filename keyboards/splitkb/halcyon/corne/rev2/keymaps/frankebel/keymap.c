...
// Encoder 0 = on-board footprint (GP24/GP23).
// No knob soldered there, so it exists in logic only, not physically.
// Encoder 1 = the VIK rotary module on the left half.
#if defined(ENCODER_MAP_ENABLE)
const uint16_t PROGMEM encoder_map[][NUM_ENCODERS][NUM_DIRECTIONS] = {
    [_COLEMAK]    = { ENCODER_CCW_CW(_______, _______), ENCODER_CCW_CW(KC_VOLD, KC_VOLU) },
    ...
    [_LAYER]      = { ENCODER_CCW_CW(_______, _______), ENCODER_CCW_CW(_______, _______) },
    [_RALT]       = { ENCODER_CCW_CW(_______, _______), ENCODER_CCW_CW(_______, _______) },
    [_ARROW]      = { ENCODER_CCW_CW(_______, _______), ENCODER_CCW_CW(_______, _______) },
};
#endif

// Mirror splitkb's stock corne halcyon_keys.c keymap.
// [10][5] mirrors the weak declarations in users/halcyon_modules/splitkb/halcyon_buttons.c.
// If a layer or button is added, bump the size in both files.
#if defined(HALCYON_ENABLE)
const uint16_t left_halcyon_buttons[10][5] = {
    [_COLEMAK]    = { KC_MM,   _______, _______, _______, _______ },
    [_NUMBER]     = { KC_MM,   _______, _______, _______, _______ },
    [_SYMBOL]     = { KC_MM,   _______, _______, _______, _______ },
    [_FUNCTION]   = { KC_MM,   _______, _______, _______, _______ },
    [_NAVIGATION] = { KC_MM,   _______, _______, _______, _______ },
    [_MEDIA]      = { KC_MM,   _______, _______, _______, _______ },
    [_LAYER]      = { KC_MM,   _______, _______, _______, _______ },
    [_RALT]       = { KC_MM,   _______, _______, _______, _______ },
    [_ARROW]      = { KC_MM,   _______, _______, _______, _______ },
};

const uint16_t right_halcyon_buttons[10][5] = {
    [_COLEMAK]    = { _______, _______, _______, _______, _______ },
    [_NUMBER]     = { _______, _______, _______, _______, _______ },
    [_SYMBOL]     = { _______, _______, _______, _______, _______ },
    [_FUNCTION]   = { _______, _______, _______, _______, _______ },
    [_NAVIGATION] = { _______, _______, _______, _______, _______ },
    [_MEDIA]      = { _______, _______, _______, _______, _______ },
    [_LAYER]      = { _______, _______, _______, _______, _______ },
    [_RALT]       = { _______, _______, _______, _______, _______ },
    [_ARROW]      = { _______, _______, _______, _______, _______ },
};
#endif
